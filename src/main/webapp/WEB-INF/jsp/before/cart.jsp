            ...
            <table width="99%" align="center" border="0" cellpadding="5"
                ...
                <c:forEach var="ce" items="${cartlist}">
                    <tr>
                        <td bgcolor="#ffffff" align="center"><a href="goodsDetail?id=${ce.id}"> <img
                                ...
                                src="${pageContext.request.contextPath}/static/logos/${ce.gpicture}" border="0"
                                title="${ce.gname}"/>
                        </a><br/><a style="text-decoration: none;" href="goodsDetail?id=${ce.id}"
                        ...
                        <td align="center" bgcolor="#ffffff" width="185px"><a
                                ...
                                class="f6" title="删除"><img
                                src="${pageContext.request.contextPath}/static/images/before/sc.png"/>
                        </a></td>
                    </tr>
                </c:forEach>
                <tr>
                ...
                <tr>
                    <td bgcolor="#ffffff" colspan="4" align="right"
                        ...
                        <a href="before"> <img src="${pageContext.request.contextPath}/static/images/before/jxgw.jpg"
                                               alt="continue"/>
                        </a>
                    </td>
                    <td bgcolor="#ffffff" align="center"
                        ...
                        <a style="cursor: pointer;" href="javascript:goOrderConfirm()">
                            <img src="${pageContext.request.contextPath}/static/images/before/qjs.jpg" alt="checkout"/>
                        </a>
                    </td>
                </tr>
            </table>
