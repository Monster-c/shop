        ...
        <div id="goodsInfo">
            <div class="imgInfo">
                <input type="hidden" name="id"
                       value="${goods.id }"/><img
                    src="${pageContext.request.contextPath}/static/logos/${goods.gpicture}"
            ...
            <div class="goods_show">
                <ul>
                    ...
                    <li><span>购买数量:</span><input type="text" name="shoppingnum"
                                                 class="good_txt" value="1"/> (库存${goods.gstore }件)
                    </li>
                </ul>
            </div>
            <p class="bottom10 top5">
                <img src="${pageContext.request.contextPath}/static/images/before/goods_ann2.gif"
