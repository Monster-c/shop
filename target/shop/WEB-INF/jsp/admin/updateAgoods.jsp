...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/css/admin/common.css" type="text/css" rel="stylesheet">
</head>
<body>
<form:form action="adminGoods/addGoods?updateAct=update" method="post" modelAttribute="goods"
            ...
            <td>
                ...
                <c:if test="${goods.gpicture != ''}">
                    <img alt="" width="50" height="50"
                         src="static/logos/${goods.gpicture}"/>
                </c:if>
            </td>
        </tr>
        <tr>
